...
export default function DogsPage()
{
  ...
  const Row = ({ index, style }: { index: number; style: React.CSSProperties }) =>
  {
    ...
    return (
      <motion.div key={dog.id} style={style} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <DogCard
          dog={dog}
      ...
      <div className="flex">
        ...
        >
          <div className="p-4 border-b border-turquoise-100 dark:border-gray-700 flex items-center space-x-2">
            <PawPrint className="h-8 w-8 text-turquoise-500" />
            <span className="text-xl font-bold text-turquoise-700 dark:text-turquoise-300">Pawfect Match</span>
          </div>
          ...
          <div className="container px-4 py-8 mx-auto">
            ...
            <div className="mb-8 w-full">
              <div className="flex flex-col items-center justify-between mb-4">
                <h2 className="text-2xl font-bold text-turquoise-800 dark:text-turquoise-200">Available Dogs</h2>
              ...
              {dogsLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-turquoise-100 dark:border-gray-700">
                  <p className="text-lg text-gray-500 dark:text-gray-400 mb-4">No dogs found matching your criteria</p>
                  <Button
                    variant="outline"
                    className="border-turquoise-200 text-turquoise-700 dark:border-gray-700 dark:text-turquoise-300"
                    onClick={() =>
